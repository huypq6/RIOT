...
static int _send(gnrc_netif_t *netif, gnrc_pktsnip_t *pkt)
{
    ...
    // nrf24l01p_t *nrf24l01p = &netdev_nrf24l01p->nrf24l01p;

    // assert(pkt != NULL);
    // assert(dev->driver == &netdev_nrf24l01p_driver);
    ...
    //     DEBUG("gnrc_nrf24l01p: First header was not generic netif header\n");
...
static const gnrc_netif_ops_t _nrf24l01p_ops = {
    .send = _send,
    .recv = _recv,
